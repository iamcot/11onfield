    ...
    <section id="recruitment-info" className="relative -mt-16 px-4 mb-8">
      <div className="w-[90%] max-w-6xl mx-auto bg-green-700 rounded-2xl shadow-xl overflow-hidden">
        <div className="grid grid-cols-3 gap-0">
          {/* Column 1: Đối tượng */}
          <div className="flex items-center justify-center p-3 md:p-6 border-r border-green-600 text-white">
            {/* Icon */}
            <img
          ...
          {/* Column 3: Tuyển sinh */}
          <div className="flex items-center justify-center p-3 md:p-6 text-white">
            {/* Icon */}
            <img
