    ...
    >
      ...
      <div className="relative h-full flex items-center justify-center px-4 pt-4 md:pt-0">
        <div className="text-center text-white max-w-4xl mx-auto w-full">
          {/* Banner Text Image */}
          <div className="mb-3 md:mb-12 w-full flex justify-center max-h-[calc(75vh-310px)] md:max-h-[calc(75vh-200px)]">
            <div className="flex flex-col items-center gap-1.5 md:gap-3 w-full max-w-[120px] md:max-w-[240px] mr-12 md:mr-32 h-full">
