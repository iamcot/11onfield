...
export default function RightNavigator({ isOpen, onClose }: RightNavigatorProps) {
  ...
  return (
    <>
      ...
      {/* Right Drawer */}
      <div
        className={`md:hidden fixed top-0 right-0 bottom-0 w-64 bg-white shadow-2xl z-50 transform transition-transform duration-300 ${
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-1/2 bg-white text-gray-600 hover:text-gray-800 rounded-full p-2 shadow-lg border border-gray-200 transition z-10"
